...
export default function Featurelist() {
  ...
  return (
    <>
      <h2>Section 1 Scholarshiop data</h2>
      <div className={style.wrapper}>
        <button
          className={style.leftButton}
          onClick={() => {
            leftScroll(refSectionOne.current);
          }}
        >
          {left}
        </button>
        ...
        <button
          ...
          onClick={() => {
            rightScroll(refSectionOne.current);
          }}
        >
          {right}
        </button>
      </div>
      <h2>Section 2 Scholarshiop data</h2>
      <div className={style.wrapper}>
        <button
          className={style.leftButton}
          onClick={() => {
            leftScroll(refSectionTwo.current);
          }}
        >
          {left}
        </button>
        ...
        <button
          ...
          className={style.rightButton}
          onClick={() => {
            rightScroll(refSectionTwo.current);
          }}
        >
          {right}
        </button>
      </div>
      <h2>Section 3 Scholarshiop data</h2>
      <div className={style.wrapper}>
        <button
          className={style.leftButton}
          onClick={() => {
            leftScroll(refSectionThree.current);
          }}
        >
          {left}
        </button>
        ...
        <button
          ...
          className={style.rightButton}
          onClick={() => {
            rightScroll(refSectionThree.current);
          }}
        >
          {right}
        </button>
